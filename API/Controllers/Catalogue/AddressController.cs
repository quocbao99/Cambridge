...
namespace API.Controllers
{
    ...
    public class AddressController : ControllerBase
    {
        ...
        public virtual async Task<AppDomainResult> GetCities([FromQuery] BaseSearch baseSearch)
        {
            ...
            {
                PagedList<Cities> pagedData = await citiesService.GetPagedListData(baseSearch);
        ...
        public virtual async Task<AppDomainResult> GetDistricts([FromQuery] DistrictsSearch baseSearch)
        {
            ...
            if (ModelState.IsValid)
            {
                PagedList<Districts> pagedData = await districtsService.GetPagedListData(baseSearch);
        ...
        public virtual async Task<AppDomainResult> GetWards([FromQuery] WardsSearch baseSearch)
        {
            ...
            if (ModelState.IsValid)
            {
                PagedList<Wards> pagedData = await wardsService.GetPagedListData(baseSearch);
                var districtsModels = (from i in pagedData.Items
